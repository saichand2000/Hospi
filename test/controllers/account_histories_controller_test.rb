...
class AccountHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_history" do
    assert_difference('AccountHistory.count') do
      post account_histories_url, params: { account_history: { patient_status: @account_history.patient_status } }
    end
  ...
  test "should update account_history" do
    patch account_history_url(@account_history), params: { account_history: { patient_status: @account_history.patient_status } }
